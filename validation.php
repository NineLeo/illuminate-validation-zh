...
return [
    ...
    */
    ...
    'gt' => [
        ...
        'file' => ':attribute 的文件size必须大于 :value kilobytes.',
        'string' => ':attribute 的字符长度必须大于 :value .',
        'array' => ':attribute 的元素个数必须大于 :value .',
    ],
    'gte' => [
        'numeric' => ':attribute 必须大于或等于 :value.',
        'file' => ':attribute 的文件size必须大于或等于 :value kilobytes.',
        'string' => ':attribute 的字符长度必须大于或等于 :value .',
        'array' => ':attribute 的元素个数必须大于或等于 :value.',
    ],
    ...
    'lt' => [
        ...
        'file' => ':attribute 的文件size必须小于 :value kilobytes.',
        'string' => ':attribute 的字符长度必须小于 :value .',
        'array' => ':attribute 的元素个数必须小于 :value .',
    ],
    'lte' => [
        'numeric' => ':attribute 必须小于或等于 :value.',
        'file' => ':attribute 的文件size必须小于或等于 :value kilobytes.',
        'string' => ':attribute 的字符长度必须小于或等于 :value .',
        'array' => ':attribute 的元素个数必须小于或等于 :value .',
    ],
    'max' => [
